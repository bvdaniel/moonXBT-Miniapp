...
export async function GET(request: Request) {
  ...
  const pointsParam = searchParams.get("points") || "10";
  const points = isNaN(Number(pointsParam)) ? "10" : pointsParam;
  const pfpUrl =
    searchParams.get("pfpUrl") || "https://i.ibb.co/QvFx17r6/logo.png";

  // Always return the image - we'll handle OpenGraph differently
